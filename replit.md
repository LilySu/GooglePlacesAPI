...
### Key Directories
- `src/components/` - React components (Header, Navigation, DashboardView, SuggestionsView, MetricsView, UploadView, SpreadsheetView, GrowingPlant, LongevityScoreHero)
...
- `src/data/` - Default data and suggestion content (defaultSessionData, suggestions)
...
### Key Components
- **App.jsx** - Main app with state management for sessions, analysis, and view routing
- **UploadView** - Dual upload: PDF for AI analysis, Excel for session tracking
- **SuggestionsView** - AI recommendations + Google Maps venue discovery + static wellness suggestions
- **DashboardView** - Session comparison charts and progress tracking
