...
import mayaProfileImg from '@assets/maria-lupan-Omae6x2qFTU-unsplash_1771112352871_1771120987643.png';
    ...
    <div className="bg-gradient-to-br from-purple-50/80 via-rose-50/80 to-orange-50/80 backdrop-blur-sm rounded-3xl p-4 sm:p-6 border border-purple-200/50 card-hover animate-fadeInUp" style={{animationDelay: '0.8s'}}>
      ...
      <div className="flex flex-col md:flex-row gap-4 sm:gap-6">
        <div className="flex-1">
          ...
          <p className="text-sm text-amber-700 mb-4 leading-relaxed line-clamp-2" style={{fontFamily: 'Work Sans, sans-serif'}}>
            {matchedUser.bio}
          </p>

          <div className="flex items-center gap-2 mb-3">
            <TrendingUp className="w-4 h-4 text-purple-500" />
            <span className="text-xs text-purple-600 font-medium uppercase tracking-wide" style={{fontFamily: 'Work Sans, sans-serif'}}>Trajectory Comparison</span>
          </div>
          <div className="bg-white/60 rounded-2xl p-3 border border-purple-100/50">
            ...
            <div className="flex justify-center gap-6 mt-1">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-amber-700" style={{fontFamily: 'Work Sans, sans-serif'}}>You</span>
              </div>
              <div className="flex items-center gap-1.5">
                <div className="w-4 h-0.5 bg-purple-500 rounded" style={{borderTop: '2px dashed #a855f7', height: 0}}></div>
                <span className="text-xs text-purple-600" style={{fontFamily: 'Work Sans, sans-serif'}}>{matchedUser.name}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex md:flex-col items-center justify-center gap-3">
          ...
          <span className="text-xs text-purple-400" style={{fontFamily: 'Work Sans, sans-serif'}}>Send a message</span>
        </div>
      </div>
    </div>
  );
