...
import { AreaChart, Area, Line, ResponsiveContainer, XAxis } from 'recharts';
...
export default function MessagingPortal({ matchedUser, sessionData, onBack }) {
  const [messages, setMessages] = useState(matchedUser.chatMessages || []);
      ...
      <div className="bg-gradient-to-r from-purple-100/80 to-rose-100/80 rounded-3xl p-5 border border-purple-200/50">
        <div className="flex items-center gap-4 mb-1">
          ...
          <div>
            ...
            <p className="text-xs text-purple-500" style={{fontFamily: 'Work Sans, sans-serif'}}>{matchedUser.distance} · {matchedUser.similarityScore}% trajectory match</p>
          </div>
        </div>
      </div>
